...
const previewBridge: RawBridge = {
  ...
  invoke: async (channel) => {
    switch (channel) {
      ...
      case "settings:get":
        return { undoWindowSec: 10, autoDraft: false, remoteImages: "always", remindClientsAfterDays: 3, remindScope: ["Clients"], readReceipts: false, readReceiptsDefault: false, readReceiptsUrl: "", readReceiptsTokenSet: false };
      case "snippets:list":
      case "drafts:list":
        return [];
